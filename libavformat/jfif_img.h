...
extern int parse_jfif_header(unsigned char *data, NetVuImageData *pic, int imglength, unsigned char **qy, unsigned char **qc, char *site, int decode_comment); // JCB 010
extern int build_comment_text(char *buffer, NetVuImageData *pic, int max);
extern void parse_comment(char *text, NetVuImageData *pic, char *site);	// PRC 008
...
extern int parse_jfif_stream(unsigned char *data, NetVuImageData *pic, int imglength, unsigned char **qy, unsigned char **qc, char *site, int handle, int (*read_func)(int handle, char *buff, int nbytes));
